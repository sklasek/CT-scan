...
```{r, alpha diversity supplemental figure, fig.height=1.5, fig.width=5}
...
```{r, ordination figure, fig.height=1.5, fig.width=5}
...
```{r, ordination-storage, fig.height=1.5, fig.width=3.5}
...
```{r, biomarkers, fig.height=2.5, fig.width=4}
